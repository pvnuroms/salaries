...
with open(r'/home/pupkin/projects/salaries/config.yaml') as mail_config:
    config = yaml.load(mail_config, Loader=yaml.FullLoader)
server_login, server_password = config.get('mail_config')
...
if __name__ == "__main__":
    mail = Mail('Тема', 'Купи слона', 'pvnuroms@mail.ru,')
    mail.send_mail()
